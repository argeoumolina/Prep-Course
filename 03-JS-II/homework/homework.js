...
function mayoriaDeEdad(edad) {
  ...
  if(edad>=18){return permitido;}
  else{return nopermitido;}
...
function conection(status) {
  ...
  var dos = "Away"
  var tres = "Offline"
  if(status === 1){return uno;}
  else if(status === 2){return dos;}
  else{return tres;}
}
...
function saludo(idioma) {
  ...
  var ingles = "Hello!"
  var esp = "Hola!"
  if(idioma === "aleman"){return aleman;}
  else if(idioma === "mandarin"){return mantarin;}
  else if(idioma === "ingles"){return ingles;}
  else{return esp;}
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  let arrayTablaDe6 = []
  for (let i=0; i<11;i++){arrayTablaDe6.push(6*i)}
